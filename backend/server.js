...
onlynft: [
    ...
    { emoji: "🐸", name: "Plush Pepe Pink Latex", price: 10000.0, weight: 99000 },    // 0%
    ...
    { emoji: "🧸", name: "Bear",                  price: 0.1,     weight: 0 } // 99.0%
  ],

  crypto: [
    { emoji: "🍑", name: "Precious Peach (random)", price: 500.0, weight: 100 },    // 0%
    { emoji: "🧸", name: "Bear",                    price: 0.1,   weight: 0 }   // 100%
  ],
};
